...
%   ROUWENHORST returns a discretization of an AR(1) process.
%
%   [Z,PI] = ROUWENHORST(N,MU,RHO,SIGMA) returns the state space Z and 
%       transition matrix PI of an AR(1) process approximated by a 
...
%            rho     scalar
%            sigma   scalar, (conditional) std. dev. of epsilon
%
