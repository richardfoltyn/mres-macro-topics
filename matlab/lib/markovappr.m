...
%   MARKOVAPPR  returns the Markov approximation of an AR(1) process.
%
%   Implementation taken from source code accompanying Ljungqvist & 
%   Sargent: Recursive Macroeconomic Theory, 3rd. edition.
%
